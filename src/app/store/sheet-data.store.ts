...
export class DataStoreService {
  ...
  private filtersSubject = new BehaviorSubject<Filters>({mirrorMatches: true, allowLegacyContent: true, timeFrame: null, metas: "none", selectedTag: [''], tournamentsOnly:false, worldQualifiersOnly:false, dataThreshold: 15});
