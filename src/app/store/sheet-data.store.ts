...
export class DataStoreService {
  ...
  private filtersSubject = new BehaviorSubject<Filters>({mirrorMatches: true, allowIllegalWarbands: true, allowIllegalDecks: true, timeFrame: null,metas: "none", selectedTag: "",dataThreshold: 15});
